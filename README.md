...
The hard part isn't fetching prices; it's deciding that two differently worded listings are the same phone, using rules general enough to work on a model that doesn't exist yet — no hardcoded product list.
